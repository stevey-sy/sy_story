        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                if (isset($_SESSION['userid'])) {
                    ...
                    $check_row = "select exists(select * from cart where userid='$id')";
                    ...
                    $sql = mq("select * from cart where userid='$id' order by idxn");
                    $check_cart = $sql ->fetch_array();

                    // 아이디와 같은 값이 있는지 체크하여 있으면 데이터 뿌려주고
                    // 없으면 No Item in Cart 보여주기
                    ...
                    while($board = $sql->fetch_array()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $board["quantity"]; ?>
                            </td>
                            <td>
                                <?php echo number_format ($board["price"]); ?>원
                            </td>
                            <td><?php echo number_format($board["quantity"] * $board["price"]); ?>원
                            </td>
            ...
            <div class="btn_area">
                ...
                if(isset($_COOKIE["shopping_cart"])) {?>
                    <a href="/"><input type="button" class="button" value="구매 취소"></a>
                    <a href="cart_to_payment.php"> <input type="submit" class="button" id="btn_buy" name="go_payment" value="구매하러 가기" />
                    </a>
                    <?php
                }
                ?>
